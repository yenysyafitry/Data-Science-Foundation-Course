...
```plantuml
30. Fill in the blanks with the correct option(s):Logistic regression is a______regression technique that is used to model data having a ________outcome
 A. linear, numeric
 B. linear, binary
 C. nonlinear, numeric
 D. nonlinear, binary
